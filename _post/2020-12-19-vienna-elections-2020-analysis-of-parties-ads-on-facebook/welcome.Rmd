...
```{r include=FALSE}
df_ads <- readr::read_rds(file=here::here("_blog_data", 
...
```{r include=FALSE}
pages_of_interest <- readxl::read_xlsx(path=here::here("_blog_data", "vienna_elections_2020_facebook", "df_pages_of_interest.xlsx")) %>% 
  # filter(include=="yes") %>% 
