...
![Example of table of 4th graders' school destination](primary-schools-in-vienna_files/vienna_schools_table.PNG){width=50% height=100%}
<br>
...
```{r, eval=T, include=F}
df_main <- readr::read_rds(here::here("_blog_data", "Vienna_primary_schools", "df_main_base.rds"))
