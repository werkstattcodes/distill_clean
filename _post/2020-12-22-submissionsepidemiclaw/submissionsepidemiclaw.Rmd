...
df_submission <- readr::read_csv2(file=here::here("_blog_data",                              "epidemic_law_submissions", "df_submission_rss.csv"))
...
df_submission <- readr::read_csv2(file=here::here("_blog_data", "epidemic_law_submissions","df_submission.csv"))
...
```{r include=FALSE}
df_submission <- readr::read_rds(file=here::here("_blog_data", "epidemic_law_submissions",
...
```{r echo=FALSE}
df_sozial_sim <- readr::read_csv2(file=here::here("_blog_data", "epidemic_law_submissions", "df_bar_sim_sozial.csv")) %>%  mutate(law="Sozialhilfegrundgesetz")
